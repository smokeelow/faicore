<?php
    $this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'About Us').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Page creation').'';
?>

<div class="wrapper">
    <div class="page-title">
        <h1><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Page creation')?></h1>
    </div>
</div>
