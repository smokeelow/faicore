<?php
$this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'About Us').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Page list').'';
?>
...
<div class="divider"></div>
    ...
    <div class="t-h-row">
        <div class="wrapper">
            <ul>
                <li><?php echo CHtml::link('<img src="/skin/backend/images/resume.png" alt="'.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Add new page').'"/><span>'.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Add new page').'</span>', 'about/create') ?></li>
            </ul>
        </div>
    </div>
    ...
    <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="fai-table">
            ...
            <tr>
                ...
                <td><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Main of "About Us"')?></td>
