<?php
$this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Category').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'New subcategory').'';
?>

<div class="wrapper">
    <div class="page-title">
        <h1><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'New subcategory')?></h1>
    </div>
</div>
