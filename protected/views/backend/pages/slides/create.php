<?php
$this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Pages').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Creation list of a set slides').'';
?>

<div class="wrapper">
    <div class="page-title">
        <h1><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Creation list of a set slides')?></h1>
    </div>
</div>
...
<div class="wrapper">
    <div class="widget">
        ...
        <?php echo $this->renderPartial('slides/_form', array('model'=>$model)); ?>
