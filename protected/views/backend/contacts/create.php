<?php
    $this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'About Us').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'New record').'';
?>

<div class="wrapper">
    <div class="page-title">
        <h1><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'New record')?></h1>
    </div>
</div>
