<?php
$this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'News').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'News list').'';
?>
...
<div class="divider"></div>
    ...
    <div class="t-h-row">
        <div class="wrapper">
            <ul>
                <li><?php echo CHtml::link('<img src="/skin/backend/images/add_new.png" alt="'.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Add news').'"/><span>'.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Add news').'</span>', 'news/create') ?></li>
            </ul>
        </div>
    </div>
