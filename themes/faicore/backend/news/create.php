<?php
    $this->pageTitle=Yii::app()->getFConfig('serverName') .' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Admin panel').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'News').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Add news').'';
?>

<div class="wrapper">
    <div class="page-title">
        <h1><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'News').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Add news')?></h1>
    </div>
</div>
