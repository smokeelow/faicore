<?php
$this->pageTitle=Yii::app()->name . ' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Admin panel').' / '.Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Creation of new announcement').'';
?>

<div class="wrapper">
    <div class="page-title">
        <h1><?php echo Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Creation of new announcement')?></h1>
    </div>
</div>
...
<div class="wrapper">
    <div class="widget">
        <div class="title">
            ...
            <?php echo $this->renderPartial('notice/_form', array('model'=>$model)); ?>
