...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            'name'=>'onmpage',
            'value'=>'$this->getStatus($data->id,$data->onmpage,"main","mpage")',
            'header'=>Yii::t(''.Yii::app()->request->cookies['language']->value.'', 'Show on "About Us"'),
            'htmlOptions'=>array('class'=>'status', 'align'=>'center'),
        ),
        array(
            'name'=>'active',
            'value'=>'$this->getStatus($data->id,$data->status,"status","status")',
